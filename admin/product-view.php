	...
	<div class="row">
        <div class="col-xs-12">
            ...
            <?php
                	...
                	$iva=mysqli_fetch_array($impuesto, MYSQLI_ASSOC);
                ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                ...
                                <input type="date" class="form-control" required  name="prod-date"> <!-- FECHA DE CADUCIDAD-->
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                <label class="control-label">Iva</label>
                                <input type="text" class="form-control" required maxlength="2" pattern="[0-9]{1,2}" name="prod-desc-price" value="<?php echo $iva['valor_iva']; ?>%" disabled>
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
