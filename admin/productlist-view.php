...
<div class="container">
 ...
 <div class="form-group label-floating">
                    <label class="control-label" for="txt_buscar">Buscar Producto por NOMBRE</label>
                    <input class="form-control" type="text" name="txt_buscar" id="txt_buscar" onkeypress="filtrarProducto(this.value);">
                </div>
