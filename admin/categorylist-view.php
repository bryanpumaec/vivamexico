...
<ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li>
        <a href="./report/listacategorias.php" target="_blank"><i class="fa fa-download" aria-hidden="true"></i> &nbsp; Generar Reporte</a>
    </li>
</ul>
...
<div class="container">
 ...
 <div class="form-group label-floating">
                    <label class="control-label" for="txt_buscar">Buscar Categoria por NOMBRE</label>
                    <input class="form-control" type="text" name="txt_buscar" id="txt_buscar" onkeypress="filtrarCategoria(this.value);">
                </div>
