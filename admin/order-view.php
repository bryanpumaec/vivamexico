        ...
        <div class="col-xs-12">
            ...
            <div class="panel panel-info">
                ...
                <div class="form-group label-floating">
                    <label class="control-label" for="txt_buscar">Buscar pedido por N° DEPÓSITO</label>
                    <input class="form-control" type="text" name="txt_buscar" id="txt_buscar" onkeypress="filtrar(this.value);">
                </div>
                    ...
                    <table class="table table-striped table-hover" id="tabla">
                        ...
                        <tbody>
                            <?php
                               ...
                               $regpagina = 30;   //NUMERO DE RESULTADOS POR PÁGINA
                                $inicio = ($pagina > 1) ? (($pagina * $regpagina) - $regpagina) : 0;

                                $pedidos=mysqli_query($mysqli,"SELECT SQL_CALC_FOUND_ROWS * FROM venta ORDER BY Estado DESC LIMIT $inicio, $regpagina");
