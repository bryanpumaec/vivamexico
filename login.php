...
<body id="container-page-login ">
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1 class="text-center tittles-logotipo">INGRESAR <small class="tittles-pages-logo"> </small></h1>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div id="container-form">
                    <form action="process/loginUS.php" method="post" role="form" class="FormCatElec" data-form="login">
