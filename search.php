       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1 class="text-center">BÚSQUEDA DE PRODUCTOS <small class="tittles-pages-logo"></small></h1>
            </div>
                ...
                <div class="row">
                  <?php
                    ...
                    if(mysqli_num_rows($consultar_productos)>=1){
                      echo '<div class="col-xs-12"><h3 class="text-center">Resultados de su busqueda con el nombre, marca o modelo <strong>"'.$search.'"</strong></h3></div><br>';
