...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs">
            <div class="col-xs-4">
              <img src="assets/logos/Vivamexlogo.png" width="220px" alt="" href="index.php">
            </div>
            <div class="col-xs-8">
              <div class="contenedor-tabla pull-right">
                <div class="contenedor-tr">
                  ...
                  <a href="informacion.php" class="table-cell-td">Quienes Somos</a>
                  <a href="mapa.php" class="table-cell-td">Nuestros locales</a>
                  ...
                  <?php
                      if(!$_SESSION['nombreAdmin']==""){
                          ...
                          <a href="login.php" class="table-cell-td"><i class="fa fa-user"></i>&nbsp; Iniciar Sesión</a>
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo">Viva México</h3>
