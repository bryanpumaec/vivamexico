...
class PDF extends FPDF
{
    ...
    {
        // Logo
        $this->Image('../assets/logos/circuloamarillo.png', 30, 8, 50);
        $this->Image('../assets/logos/camionvivamex.png', 210, 8, 60);
        $this->SetFont('Times', 'B', 30);
        // Movernos a la derecha
        $this->Cell(1);
        // Título
        $this->Cell(0, 10, utf8_decode('Recibo de pedido'), 0, 0, 'C');
        ...
        $this->Cell(1);
        // Título
        $this->Cell(0, 10, utf8_decode('Viva México EC'), 0, 0, 'C');
        // Salto de línea
        $this->Ln(10);
        ...
        $this->Cell(1);
        // Título
        $this->Cell(0, 10, utf8_decode('Av. Teodoro Gómez y Juana Atabalipa'), 0, 0, 'C');
        ...
        $this->Cell(1);
        // Título
        $this->Cell(0, 10, utf8_decode('+593 969 750 973'), 0, 0, 'C');
...
$pdf->Ln(5);
$pdf->SetFont("Times", "b", 12);
$pdf->Cell(35, 5, utf8_decode('N° de comprobante:  '), 0);
$pdf->SetFont("Times", "", 12);
$pdf->Cell(50, 5, utf8_decode(' '.' '.$dVenta['NumeroDeposito']), 0);
$pdf->Ln(5);
$pdf->SetFont("Times", "b", 12);
...
$pdf->Cell(100, 10, utf8_decode('Precio'), 1, 0, 'C');
$pdf->Cell(30, 10, utf8_decode('Cantidad'), 1, 0, 'C');
$pdf->Cell(45, 10, utf8_decode('Total'), 1, 0, 'C');
...
while ($fila1 = mysqli_fetch_array($sDet, MYSQLI_ASSOC)) {
    ...
    $pdf->Cell(100, 10, utf8_decode('$' . $fila1['PrecioProd']), 1, 0, 'C');
    $pdf->Cell(30, 10, utf8_decode($fila1['CantidadProductos']), 1, 0, 'C');
    $pdf->Cell(45, 10, utf8_decode('$' . $fila1['PrecioProd'] * $fila1['CantidadProductos']), 1, 0, 'C');
...
$pdf->SetFont('Times', '', 20);
$pdf->Cell(1);
$pdf->Cell(0, 10, utf8_decode('Con este documento usted podrá recibir su pedido'), 0, 0, 'C');


$pdf->Output('Recibo #' . $dVenta['NumeroDeposito'].'.pdf', 'I',);
