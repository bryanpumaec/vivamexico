       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1 class="text-center">PRODUCTOS <small class="tittles-pages-logo"></small></h1>
            </div>
            <?php
              $checkAllCat=ejecutarSQL::consultar("SELECT * FROM categoria ORDER BY Nombre ASC");
              ...
              <div class="row">
                <?php
                  ...
                  if(mysqli_num_rows($consultar_productos)>=1){
                    echo '<h3 class="text-center">Productos de la marca <strong>'.$datCat['Nombre'].'</strong></h3><br>';
                ...
                ?>
                    <div class="col-xs-12 col-sm-6 col-md-4">
                         <div class="thumbnail">
                           ...
                           ">
                           <div class="caption">
                             <h2 class="text-center"><?php echo $prod['NombreProd']; ?></h2>
                             <h3 class="text-center"><?php echo $prod['Marca']; ?></h3>
                             ...
                             <?php else: ?>
                              <h3 class="tittles-pages-logo text-center">$<?php echo $prod['Precio']; ?></h3>
                             <?php endif; ?>
                             <p class="text-center">
